...
```bash
git clone git clone https://github.com/NinjaCoin-Master/cryptonote-nodejs-pool-ninjacoin.git
cd cryptonote-nodejs-pool-ninjacoin
...
* TurtleCoin TRTL: `TRTLuzoc4NwfsXC7FUsNTefb43CFhi6ddhBWcTSUv37UB3eN2M5Yg4tCNCxReqvY5DQzLPz5t4McHY8CvRgF5uRMFecrtm3WMew`
